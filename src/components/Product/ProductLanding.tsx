...
import CarouselSlider from "../atoms/carousel";
// import PricingSection from "./PricingSection";
import ChangeLanguage from "../atoms/languageaccordion";
            ...
            <div className="lg:grid lg:grid-cols-2 lg:gap-8">
              <div className="mx-auto max-w-md px-6 sm:max-w-2xl sm:text-center lg:flex lg:items-center lg:px-0 lg:text-left">
                <div className="lg:py-24">
                  ...
                  <h1 className="mt-4 font-bold tracking-tight text-gray-300 sm:mt-5 text-xl sm:text-3xl lg:mt-6 xl:text-3xl">
                    Welcome to Talk To The World
                  </h1>
                  <h1 className="mt-4 text-4xl font-bold tracking-tight text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                    <span className="block">Best Language App</span>
